...
tweet7 <- paste0("Op basis van methode (2) is in week 23 de ondersterfte ",round(deaths_thisweek,0),
...
tweet9 <- paste0("Oversterfte Europa (analyses EuroMOMO): oversterfte in Europa is ook voorbij, aangezien er deze week ondersterfte was (cumulatieve sterfte zakte met 1500). De enige landen waar afgelopen week nog enige oversterfte was zijn Zweden + VK. Totale oversterfte week 12 t/m ",weeknumber," = 168000.")
...
tweet12 <- "Eindnoot 2: Ik heb wat tijd gehad om de code voor deze analyses uit te schrijven zodat ik mijn draadjes hierover elke week automatisch kan draaien. Voor de geinteresseerden, de R code is hier te vinden: https://github.com/mzelst/covid-19. Ik maak de code een andere keer iets eleganter :)"
