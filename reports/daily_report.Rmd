---
title             : "Epidemiologische situatie COVID-19 in Nederland - 2 augustus 2020"
...
tweet2 <- paste0("Patiënten verpleegafdeling 
...
**Samenvatting**  
Tot en met `r Sys.Date()` zijn er in Nederland in totaal `r last(all.data$cases)` COVID-19 patiënten gemeld aan het RIVM. Van alle gemelde patiënten is de helft 57 jaar of ouder. Tot nu toe zijn `r last(all.data$hospitalization)` van de gemelde patiënten opgenomen in het ziekenhuis en `r last(all.data$deaths)` mensen overleden.
...
colnames(sex.data.table) <- c("Leeftijdsgroep","Totaal","%","Totaal","%","Totaal","%")
