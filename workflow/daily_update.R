...
Perc. positief (gem. ",format(as.Date(Sys.Date()-6), "%d %b")," - ",format(as.Date(Sys.Date()-4), "%d %b"),"): ",format(all.data[nrow(all.data)-4,"pos.rate.3d.avg"],decimal.mark = ",",big.mark =".",big.interval = 3),"%
