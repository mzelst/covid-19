...
Perc. positief ",format(as.Date(Sys.Date()-5), "%d %b")," - ",format(as.Date(Sys.Date()-3), "%d %b"),": ",format(all.data[nrow(all.data)-3,"pos.rate.3d.avg"],decimal.mark = ",",big.mark =".",big.interval = 3),"%
