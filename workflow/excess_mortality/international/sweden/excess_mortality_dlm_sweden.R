...
write.csv(totals, file = paste0("workflow/excess_mortality/international/sweden/dlm_2020.csv"))
...
ggplot(fig2.1_dt, aes(factor(week), cbs_deaths, group = 1)) +
  ...
  ylab('') + 
  theme_bw()
ggsave('workflow/excess_mortality/international/sweden/fig2.1.png')
...
write.csv(fig2.2_dt,file = "workflow/excess_mortality/international/sweden/fig2.2_dt.csv")
...
ggplot(fig2.2_dt, aes(factor(week), Gemiddeld)) +
  ...
  theme_bw()
ggsave('workflow/excess_mortality/international/sweden/fig2.2.png')
...
write.csv(fig4.1.1_dt,file = "workflow/excess_mortality/international/sweden/fig4.1.1_dt.csv")
...
ggplot(fig4.1.1_dt, aes(factor(week), mid, group = 1)) +
  ...
  ylab('Beta') + 
  theme_bw()
ggsave('workflow/excess_mortality/international/sweden/fig4.1.1.png')
...
write.csv(fig4.1.2_dt,file = "workflow/excess_mortality/international/sweden/fig4.1.2_dt.csv")
...
ggplot(fig4.1.2_dt,
  ...
  ylab('') + 
  theme_bw()
ggsave('workflow/excess_mortality/international/sweden/fig4.1.2.png')
...
write.csv(fig4.2.1_dt,file = "workflow/excess_mortality/international/sweden/fig4.2.1_dt.csv")
...
ggplot(fig4.2.1_dt, aes(factor(week), mid, group = 1)) +
  ...
  xlab('Week') + 
  theme_bw()
ggsave('workflow/excess_mortality/international/sweden/fig4.2.1.png')
...
write.csv(fig4.2.2_dt,file = "workflow/excess_mortality/international/sweden/fig4.2.2_dt.csv")
...
ggplot(fig4.2.2_dt, aes(variable, value)) +
  ...
  theme_bw()
ggsave('workflow/excess_mortality/international/sweden/fig4.2.2.png')
