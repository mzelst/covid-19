...
cbs_oversterfte <- data.table(read_excel('data/Berekening oversterfte CBS.xlsx', range = 'F3:I23', col_names = F))
...
## write to excel
write.xlsx(fig2.1_dt, 'output/figures.xlsx', sheetName = 'fig2.1')
...
## write to excel
write.xlsx(fig2.2_dt, 'output/figures.xlsx', sheetName = 'fig2.2', append = T)
