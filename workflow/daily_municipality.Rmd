...
cat(sprintf("%s / 355 gemeentes met nieuwe besmettingen (w: %s )",
  format_custom_number(int.count.municipality.today),
  format_custom_number(int.count.municipality.week, TRUE)
))

rm(int.count.municipality.today, int.count.municipality.week)
```
