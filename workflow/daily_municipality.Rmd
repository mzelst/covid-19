...
print_detailed <- function(data, include_color = TRUE, two_weeks = FALSE, since_beginning = FALSE){
  ...
  cat(sprintf(template.example, 
    ...
    ifelse(since_beginning, 'in totaal<br/>', 'sinds 1 december'),
...
🟧   Waakzaam ( 5-50 / 100.000 inwoners / 7 dagen )   
🛑   Zorgelijk ( 50-150 / 100.000 inwoners / 7 dagen )  
🟣   Ernstig ( 150-250 / 100.000 inwoners / 7 dagen )   
...
print_municipality_data(slice(dat.cases.today.all,(241:355)))
...
print_detailed(dat.total, FALSE, TRUE)
rm(dat.total)
```
...
print_municipality_data(slice(dat.hosp.today.all,(0:115)), "", FALSE, TRUE)
...
print_municipality_data(slice(dat.hosp.today.all,(116:240)), "", FALSE, TRUE)
...
print_municipality_data(slice(dat.hosp.today.all,(241:355)), "", FALSE, TRUE)
...
print_municipality_data(slice(dat.deaths.today.all,(241:355)), "", FALSE, TRUE)
